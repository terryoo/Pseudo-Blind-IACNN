...
Est_Par.mbSize = 64;
Est_Par.stride = 64;
Est_Par.net_model = 'deploy/Est_mpeg_deploy.prototxt';
Est_Par.net_weights = 'model_mpeg/mpeg_est.caffemodel';
...
Net34 = caffe.Net(Par.net_model, 'model_mpeg/5.caffemodel', 'test');
Net37 = caffe.Net(Par.net_model, 'model_mpeg/10.caffemodel', 'test');
Net42 = caffe.Net(Par.net_model, 'model_mpeg/20.caffemodel', 'test');
Net47 = caffe.Net(Par.net_model, 'model_mpeg/30.caffemodel', 'test');

%% Test Sets & Save Folder 
testfolder = './testset/mpeg/comp5/BQTerrace/';
